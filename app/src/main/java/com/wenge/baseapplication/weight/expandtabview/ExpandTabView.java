...
//    private ArrayList<View> mViewList = new ArrayList<>();
    ...
    /**
     * @param textArray: ListView中item对应的text值的集合..(title)
     * @param viewArray: 当前Layout中需要加入的View..(ChildView)
     */
    @SuppressLint("ResourceAsColor")
    public void setValue(ArrayList<String> textArray, ArrayList<View> viewArray) {
        ...
        for (int i = 0; i < viewArray.size(); i++) {
            ...
            if (i != viewArray.size() - 1) {
                ...
                RelativeLayout.LayoutParams params = new RelativeLayout .LayoutParams(1,40);
                params.setMargins(0,10,0,10);
                textView.setLayoutParams(params);
                textView.setWidth(2);
                textView.setHeight(40);
                textView.setGravity(Gravity.VERTICAL_GRAVITY_MASK);
                textView.setBackground(getContext().getDrawable(R.color.colorAccent));
